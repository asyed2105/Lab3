...
public class CountryCodeConverter {
    ...
    private Map<String, String> codeToCountry; // A map for storing country code -> country name
    private Map<String, String> countryToCode; // A reverse map for storing country name -> country code
